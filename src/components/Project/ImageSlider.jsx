...
export default function ImageSlider({ images = [] }) {
  ...
  return (
    <div className="h-[300px] sm:h-[500px] lg:h-[700px] rounded-xl my-4 w-full bg-gradient-to-br from-gray-900 to-gray-800 overflow-hidden relative flex items-center group">
      <div
      ...
      {images.length > 1 && (
        <>
          <button
            ...
            className="absolute top-1/2 left-2 sm:left-4 transform -translate-y-1/2 bg-white/10 backdrop-blur-md text-white p-2 sm:p-3 rounded-full shadow-lg z-20 
          ...
          <button
            onClick={goToNext}
            className="absolute top-1/2 right-2 sm:right-4 transform -translate-y-1/2 bg-white/10 backdrop-blur-md text-white p-2 sm:p-3 rounded-full shadow-lg z-20 
          opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-white/20"
