...
const ImageSlider = ({ images }) => {
  ...
  return (
    <div className="relative w-full h-96 md:h-[500px] overflow-hidden rounded-2xl group">
          ...
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex gap-2">
            {images.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all ${index === currentIndex ? "bg-white w-4" : "bg-white/50 w-2"
                  }`}
