...
export default function CreateTeamPopUp({ newTeamName, setNewTeamName, setIsFormVisible, handleCreateTeam, teamLeader, setTeamLeader, member1, setMember1, member2, setMember4, setTeamLogo }) {
  ...
  return (
    <div className="bg-gray-800 relative z-50">
      <div className="mb-4">
        <label htmlFor="teamName" className="gird text-sm font-medium text-white mb-2">
          Team Name
        </label>
        <input
          type="text"
      ...
      <div className="mb-4">
        <label htmlFor="teamLeader" className="block text-sm font-medium text-white mb-2">
          Team Leader
        </label>
        <input
          type="text"
      ...
      <div className="mb-4">
        <label htmlFor="member1" className="block text-sm font-medium text-white mb-2">
          Member 1
        </label>
        <input
          type="text"
      ...
      <div className="mb-4">
        <label htmlFor="member2" className="block text-sm font-medium text-white mb-2">
          Member 2
        </label>
        <input
          type="text"
      ...
      <div className="mb-4">
        <label htmlFor="member3" className="block text-sm font-medium text-white mb-2">
          Member 3
        </label>
        <input
          type="text"
      ...
      <div className="mb-4">
        <label htmlFor="member4" className="block text-sm font-medium text-white mb-2">
          Member 4
        </label>
        <input
          type="text"
      ...
      <div className="flex justify-end space-x-3">
        <button
          ...
          className="px-4 py-2 text-sm text-white hover:text-white focus:outline-none bg-black rounded-md font-semibold"
        >
          Cancel
        </button>
        <button
          type="submit"
          className="px-4 py-2 bg-cyan-400 text-black rounded-md hover:bg-brandPrimary focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-opacity-50 font-semibold transition duration-300"
        >
          Create Team
        </button>
      </div>
