    ...
    <div className="bg-gray-800 p-2 m-2 rounded-md">
      <div className="flex gap-2">
        ...
        <div className="flex-1 text-sm">
          ...
          <div className="flex hover:text-white text-white cursor-pointer items-center mt-4 mb-2 gap-2">
            <FaGithub className="text-black text-lg" />
            <p>GitHub</p>
          </div>
          <div className="flex hover:text-white text-white cursor-pointer items-center gap-2">
