  ...
  return (
    <div className="w-full p-4 h-full relative flex flex-col gap-2 items-center">
      ...
      <img
        ...
        className="w-32 h-32 object-cover rounded-full shadow-md shadow-gray-600 border border-gray-700"
        alt=""
      />
      ...
      <div className="flex mt-4 items-center gap-4">
        ...
        <img className="w-8 h-8 object-cover hover:scale-105 cursor-pointer bg-gray-600 rounded-full" src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/GitHub_Invertocat_Logo.svg/1200px-GitHub_Invertocat_Logo.svg.png" alt="" />
