...
export default function Profile() {
  return (
    <div className="min-h-[calc(100vh-64px)] px-10 py-4 bg-black">
      <div className="flex h-full gap-2 flex-col w-full">
        <div className="flex-[5] flex gap-2">
          <div className="flex-1 rounded-md bg-gray-900 backdrop:opacity-50">
            <ProjectSection />
          </div>
          <div className="flex-[2] flex flex-col gap-2">
            ...
            <div className="flex-[4] flex gap-2">
              <div className="flex-[5] rounded-md bg-gray-900 backdrop:opacity-50">
                <ProfileSection />
              </div>
              <div className="flex-[4] rounded-md bg-gray-900 backdrop:opacity-50">
                <TechStackSection />
              </div>
            </div>
          </div>
